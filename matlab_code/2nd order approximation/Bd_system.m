function [S,I,P,Q,Z,load,variance,R0,stability] = Bd_system(S_hat,parms)
         %equlibrium
         ...
         equ=cell2mat(equ)';
         S=equ(:,1);I=equ(:,2);P=equ(:,3);Q=equ(:,4);Z=equ(:,5);load=P./I;variance=Q./I - load.^2;
         %R0
         R0=arrayfun(@(n) Bd_R0(S_hat,I(n),P(n),Q(n),parms(n, 1), parms(n, 2), parms(n, 3), parms(n, 4), ...
                                       parms(n, 5), parms(n, 6), parms(n, 7), parms(n, 8), ...
                                       parms(n, 9), parms(n, 10), parms(n, 11)), ...
                                       1:size(parms, 1), 'UniformOutput', false);
          R0=cell2mat(R0)';
         %stability from jacobian
          stability=arrayfun(@(n) Bd_stability(S(n),I(n),P(n),Q(n),Z(n),parms(n, 1), parms(n, 2), parms(n, 3), parms(n, 4), ...
                                       parms(n, 5), parms(n, 6), parms(n, 7), parms(n, 8), ...
